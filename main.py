...
class Management:
    def __init__(self, root):
        ...
        # Buttons
        self.add_bt = Button(self.frame_1, text='REGISTER', font=(self.font_1, 12, "bold"), bd=2, command=self.AddStudent, 
                      bg=self.color_4,fg=self.color_3).place(x=88,y=40,width=100)
        self.view_bt = Button(self.frame_1, text='SIGN IN', font=(self.font_1, 12, "bold"), bd=2, command=self.GetContact_View,
                      cursor="hand2", bg=self.color_4,fg=self.color_3).place(x=228,y=40,width=90)
        self.update_bt = Button(self.frame_1, text='UPDATE', font=(self.font_1, 12, "bold"), bd=2, command=self.GetContact_Update, cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=358,y=40,width=90)
        self.delete_bt = Button(self.frame_1, text='DELETE', font=(self.font_1, 12, "bold"), bd=2, command=self.GetContact_Delete,cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=478,y=40,width=90)
        self.clear_bt = Button(self.frame_1, text='CLEAR', font=(self.font_1, 12, "bold"), bd=2, command=self.ClearScreen, cursor="hand2",
                      bg=self.color_4,fg=self.color_3).place(x=598,y=40,width=90)
        self.exit_bt = Button(self.frame_1, text='CLOSE', font=(self.font_1, 12, "bold"), bd=2, command=self.Exit,cursor="hand2", bg=self.color_4,
                      fg=self.color_3).place(x=728,y=40,width=90)
    ...
    def AddStudent(self):
        ...
        self.name = Label(self.frame_2, text="First Name", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=20)
        self.name_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.name_entry.place(x=100,y=50, width=200)

        self.surname = Label(self.frame_2, text="Last Name", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=20)
        self.surname_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.surname_entry.place(x=530,y=50, width=200)

        self.course = Label(self.frame_2, text="Course", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=80)
        self.course_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.course_entry.place(x=100,y=110, width=200)

        self.Course_Package = Label(self.frame_2, text="Course Package", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=80)
        ...
        self.date = Label(self.frame_2, text="Date", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=140)
        self.date_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.date_entry.place(x=100,y=170, width=200)

        self.age = Label(self.frame_2, text="Age", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=140)
        self.age_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.age_entry.place(x=530,y=170, width=200)

        self.gender = Label(self.frame_2, text="Gender", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=200)
        self.gender_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.gender_entry.place(x=100,y=230, width=200)

        self.birth = Label(self.frame_2, text="Birthday", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=200)
        self.birth_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.birth_entry.place(x=530,y=230, width=200)

        self.contact = Label(self.frame_2, text="Contact No", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=260)
        self.contact_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.contact_entry.place(x=100,y=290, width=200)

        self.email = Label(self.frame_2, text="Email", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=260)
        self.email_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.email_entry.place(x=530,y=290, width=200)

        self.Current_Course = Label(self.frame_2, text="Current Course", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=320)
        ...
        self.Pending_Course = Label(self.frame_2, text="Pending Course", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=320)
        ...
        self.Completed_Course = Label(self.frame_2, text="Completed Course", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=380)
        ...
        self.Total_Fees = Label(self.frame_2, text="Total Fees", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=380)
        ...
        self.next_bt_1 = Button(self.frame_2, text='Next', font=(self.font_1, 12, "bold"), bd=2, command=self.Next, cursor="hand2",
        bg=self.color_1,fg=self.color_3).place(x=365,y=520,width=100)

        self.Paid_Fees = Label(self.frame_2, text="Paid Fees", font=(self.font_2, 15), bg=self.color_2).place(x=100,y=440)
        self.Paid_Fees_entry = Entry(self.frame_2, bg=self.color_4, fg=self.color_3)
        self.Paid_Fees_entry.place(x=100,y=470, width=200)

        self.Balance_Fees = Label(self.frame_2, text="Balance Fees", font=(self.font_2, 15), bg=self.color_2).place(x=530,y=440)
        ...
        self.submit_bt_1 = Button(self.frame_2, text='Submit', font=(self.font_1, 12, "bold"), bd=2, command=self.Submit, cursor="hand2",
        bg=self.color_1,fg=self.color_3).place(x=365,y=520,width=100)
    ...
    def GetContact_View(self):
        ...
        self.getInfo = Label(self.frame_2, text="Log-In using Email/Contact Number", font=(self.font_2, 18, "bold"), bg=self.color_2).place(x=325,y=110)

        self.getInfoEmail = Label(self.frame_2, text="Email", font=(self.font_2, 18), bg=self.color_2).place(x=360,y=180)
        self.getInfoEmail_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfoEmail_entry.place(x=360, y=220, width=250, height=30)
        
        self.getInfoContact = Label(self.frame_2, text="Contact Number", font=(self.font_2, 18), bg=self.color_2).place(x=360,y=280)
        self.getInfoContact_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfoContact_entry.place(x=360, y=320, width=250, height=30)
        
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 10, "bold"), bd=2, command=self.CheckContact_View, cursor="hand2", 
        bg=self.color_1,fg=self.color_3).place(x=440,y=390,width=80)
            
    '''To update a student details, get the contact number'''
    def GetContact_Update(self):
        self.ClearScreen()

        self.getInfo = Label(self.frame_2, text="Update using Email/Contact Number", font=(self.font_2, 18, "bold"), bg=self.color_2).place(x=325,y=110)
    ...
    def GetContact_Delete(self):
        ...
        self.getInfo = Label(self.frame_2, text="Enter Contact Number", font=(self.font_2, 18), bg=self.color_2).place(x=332,y=170)
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=350, y=220, width=200, height=30)
        
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 10, "bold"), bd=2, command=self.DeleteData, cursor="hand2", 
    ...
    def CheckContact_View(self):
       if self.getInfoEmail_entry.get() == "" and self.getInfoContact_entry.get() == "":
            messagebox.showerror("Error!", "Please enter your email/contact number",parent=self.window)
       
       elif self.getInfoEmail_entry.get() != "" and self.getInfoContact_entry.get() == "":
           try:
               connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
               curs = connection.cursor()
               curs.execute("select * from student_register where email=%s", self.getInfoEmail_entry.get())
               row=curs.fetchone()
               if row == None:
                   messagebox.showerror("Error!","Email doesn't exists",parent=self.window)
               else:
           ...
           try:
               connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
               curs = connection.cursor()
               curs.execute("select * from student_register where contact=%s", self.getInfoContact_entry.get())
               row=curs.fetchone()
               if row == None:
    ...
    def Checkdate_View(self):
        if self.getInfo_entry.get() == "":
            messagebox.showerror("Error!", "Please enter your Date",parent=self.window)
        else:
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                curs = connection.cursor()
                ...
                if row == None:
                    messagebox.showerror("Error!","date doesn't exists",parent=self.window)
                else:
                    self.ShowDetails(row)
                    connection.close()
            except Exception as e:
    ...
    def CheckContact_Update(self):
        if self.getInfo_entry.get() == "" and self.getInfo_entry.get() == "":
            messagebox.showerror("Error!", "Please enter your email/contact number",parent=self.window)
        ...
        elif self.getInfoContact_entry.get() == "" and self.getInfoContact_entry.get() != "":
            try:
                connection = pymysql.connect(host=self.host, user=self.user, password=self.password, database=self.database)
                curs = connection.cursor()
                curs.execute("select * from student_register where contact=%s", self.getInfoContact_entry.get())
